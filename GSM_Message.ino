...
void SendMessage()
{
mySerial.println("AT+CMGF=1");    //Sets the GSM Module in Text Mode //AT+CMGF, SMS Format //MSG FORMAT 0:PDU, 1:TEXT
delay(1000);  // Delay of 1000 milli seconds or 1 second
mySerial.println("AT+CMGS=\"+919886600145\"\r");  // AT+CMGS, Send Message
